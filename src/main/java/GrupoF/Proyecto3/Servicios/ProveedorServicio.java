...
public class ProveedorServicio {
    ...
    public void registrarProveedor (String nombreApellido, String contrasenia, Integer dni, String correo, Integer telefono, Integer numeroMatricula, String categoriaServicio, Double costoHora){
        ...
        validarP(nombreApellido, contrasenia, correo, telefono, numeroMatricula, categoriaServicio, costoHora);
    ...
    private void validarP(String nombreApellido, String contrasenia, String correo, Integer telefono, Integer numeroMatricula, String categoriaServicio, Double costoHora) throws Exception{
